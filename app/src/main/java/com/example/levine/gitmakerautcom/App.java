...
//                    .debug("OkGo", Level.INFO, true)
                    ...
                    .setConnectTimeout(25000)  //全局的连接超时时间
                    .setReadTimeOut(25000)     //全局的读取超时时间
                    .setWriteTimeOut(25000)    //全局的写入超时时间
                    //可以全局统一设置缓存模式,默认是不使用缓存,可以不传,具体其他模式看 github 介绍 https://github.com/jeasonlzy/
//                    .setCacheMode(CacheMode.IF_NONE_CACHE_REQUEST)

                    //可以全局统一设置缓存时间,默认永不过期,具体使用方法看 github 介绍
//                    .setCacheTime(300*1000)
...
//                    .addCommonParams(params);   //设置全局公共参数
        ...
        OkGo.getInstance().getCommonHeaders().put("timestamp", Integer
                .parseInt(currentTimeMillis / 1000 + "") + "");
        OkGo.getInstance().getCommonHeaders()
                .put("Environment", "released");
        OkGo.getInstance().getCommonHeaders()
                .put("Version", "v1");
    }
}
